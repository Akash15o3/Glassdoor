...
class SearchBar extends Component {
  ...
  handleClick = () => {
    ...
    this.props.history.push(`/student/CompanySearchResults`);
  }
  ...
  render() {
    ...
    return (
      <nav id="navbar">
        ...
        <input value={search} onChange={this.searchChangeHandler} id="searchBox" type="text" placeholder="Company name..." name="search" style={{ position: 'relative', left: '40px', top: '25px', height: '40px', width: '400px' }} />
