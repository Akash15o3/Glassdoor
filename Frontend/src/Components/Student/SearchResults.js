                    ...
                    <div className="col-lg-7">
                      <div className="row justify-content-start">
                        ...
                        <div className="col-9 pr-0">
                          <h2>
                            <a href="/Overview/Working-at-McDonald-s-EI_IE432.11,21.htm">McDonald's</a>
                            <div>
                              <span>
                          ...
                          <div>
                            <p className="hqInfo adr m-0"><span>North York, Canada</span></p>
                            <p className="webInfo mb-0 mt-xxsm"><span><a href="http://www.mcdonalds.com">www.mcdonalds.com</a></span></p>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="row justify-content-between">
                        <div className="ei-contribution-wrap col-4 pl-lg-0 pr-0">
                          <a className="eiCell cell reviews d-inline-block py-sm" href="/Reviews/McDonald-s-San-Francisco-Reviews-EI_IE432.0,10_IL.11,24_IM759.htm">
                            <span className="num h2"> 42k</span>
